...
--     Работы
       ...
       (3, 20, 1, 'Portfolio'),
       (3, 21, 1, '<ul> <li> Presentation of works, section "about me" </li> <li> CRUD of all data provided on the site </li> <li> Original UI/UX design , Mobile first </li><li>Switch languages, edit translations</li></ul>');
